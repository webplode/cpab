...
export function AdminKPICards() {
    ...
    useEffect(() => {
        apiFetchAdmin<KPIData>('/v0/admin/dashboard/kpi')
            .then(setData)
            .catch(console.error)
    ...
    const cards: KPICardProps[] = [
        ...
        },
        {
            ...
            value: `${data?.avg_request_time_ms ?? 0}ms`,
            trend: formatTrend(data?.request_time_trend ?? 0),
            trendType: getTrendType(data?.request_time_trend ?? 0),
        },
        {
            icon: 'check_circle',
