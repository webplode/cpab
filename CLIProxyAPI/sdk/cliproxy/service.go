...
func (s *Service) Run(ctx context.Context) error {
	...
	// Start background model catalog updater so the latest model definitions
	// (including models not present in the embedded catalog) are fetched from
	// remote on startup and refreshed periodically.
